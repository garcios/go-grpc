...
type User struct {
	...
	// Types that are valid to be assigned to ElectronicCommunicationChannel:
	//
	//	*User_SocialMedia
	//	*User_InstantMessaging
	ElectronicCommunicationChannel isUser_ElectronicCommunicationChannel `protobuf_oneof:"electronic_communication_channel"`
...
func (x *User) GetElectronicCommunicationChannel() isUser_ElectronicCommunicationChannel {
	if x != nil {
		return x.ElectronicCommunicationChannel
	}
	return nil
}
...
func (x *User) GetSocialMedia() *SocialMedia {
	if x != nil {
		if x, ok := x.ElectronicCommunicationChannel.(*User_SocialMedia); ok {
...
func (x *User) GetInstantMessaging() *InstantMessaging {
	if x != nil {
		if x, ok := x.ElectronicCommunicationChannel.(*User_InstantMessaging); ok {
...
type isUser_ElectronicCommunicationChannel interface {
	isUser_ElectronicCommunicationChannel()
}
...
func (*User_SocialMedia) isUser_ElectronicCommunicationChannel() {}

func (*User_InstantMessaging) isUser_ElectronicCommunicationChannel() {}
...
var file_proto_basic_user_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xac, 0x04, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x22,
	0x0a, 0x20, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x6f, 0x6e, 0x69, 0x63, 0x5f, 0x63, 0x6f, 0x6d,
	...
	0x65, 0x22, 0x3b, 0x0a, 0x09, 0x50, 0x61, 0x70, 0x65, 0x6c, 0x4d, 0x61, 0x69, 0x6c, 0x12, 0x2e,
	...
	0x2f, 0x67, 0x61, 0x72, 0x63, 0x69, 0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63,
	0x2f, 0x69, 0x6e, 0x74, 0x72, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x67, 0x65, 0x6e, 0x2f,
